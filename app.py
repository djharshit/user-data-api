...
def func1():
    ...
    if request.method == "GET":
        ...
        result = jsonify({"Datetime": datetime.now(), "AllUsers": list(all_data)})
...
parser.add_argument(
    "--host",
    type=str,
    default="mongodb://127.0.0.1:27017/data",
    required=False,
    help="The mongodb connection string of the database",
)

if __name__ == "__main__":
    args = parser.parse_args()
    print("Connecting to the database...")
    client = Connection(host=environ.get("MONGO_URI", args.host))
